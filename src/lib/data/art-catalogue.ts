...
// ---- Arte moderno y vanguardias (11-25) ----
{
    ...
    period: 'Protocubismo',
    country: 'Francia',
    license: 'Public Domain (obra 1910)',
    chessRole: 'central_theme',
    chessNote: 'Duchamp, ajedrecista apasionado que «abandonó el arte por el ajedrez»: sus hermanos Raymond y Jacques ante el tablero. Escribió un tratado de finales con Halberstadt.',
